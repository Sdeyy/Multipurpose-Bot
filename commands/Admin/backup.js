...
if(client.config.DISABLE_COMMANDS.DISABLED.includes("backup")) return interaction.reply({ 
...
module.exports = {
    ...
    run: async (client, interaction, options) => {
        ...
        if(interaction.user.id != client.config.OWNERID || interaction.guild.ownerId ) return interaction.reply({content: `${client.messages.NO_PERMSUSER}`, ephemeral: true});
